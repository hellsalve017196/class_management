		...
		<tbody>
        	<form method="post" action="<?php echo base_url();?>index.php?teacher/attendance_selector" class="form">
            	<tr class="gradeA">
                    ...
                    <td align="center">
                        <input type="submit" value="<?php echo get_phrase('manage_attendance');?>" class="btn btn-info"/>
                        <input type="button" onclick="zn()" value="<?php echo get_phrase('print_total_attendance_for_selected_class');?>" class="btn btn-success"/>
                    </td>
                </tr>
            </form>
		</tbody>
...
<div class="col-sm-offset-3 col-md-6">
    <table  class="table table-bordered">
        ...
        <tbody>
        	...
        	<?php 
			//STUDENTS ATTENDANCE
			$students	=	$this->db->query("SELECT student.student_id,student.name,student.roll,student_and_course.c_id FROM student JOIN student_and_course ON student.student_id = student_and_course.s_id WHERE student_and_course.c_id =".$class_id)->result_array();
                    ...
                    <tr class="gradeA">
                        ...
                        <td align="center">
                            ...
                            $verify_data = array('student_id' => $row['student_id'],
                                'date' => $full_date,'class_id' => $row['c_id']);
            ...
            {
                echo "there is no student in the class";
            }
			?>
    </table>
</div>
...
<script type="text/javascript">
    function zn()
    {
        ...
        http = '<? echo base_url() ?>'+'index.php?teacher/attendance_printout/'+class_id;

...
<table class="table table-bordered datatable" id="table_export">
    ...
    <tbody>
        <?php 
                $students	=	$this->db->query('SELECT student_and_course.s_id,student.name AS jam,student.roll AS roll,student.address AS address,student.email AS email,student.student_id AS student_id FROM student_and_course JOIN student ON student_and_course.s_id = student_id WHERE student_and_course.c_id = '.$class_id)->result_array();
